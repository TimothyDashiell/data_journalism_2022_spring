...
**Answer** There are cities that are on the sheet twice, but are capitalized differently so it's recognized as two different cities instead of the same city.
...
**Answer** If a city was all CAPS before, they changed to that only the first letter was capitalized (ex:Phoenix), it also capitalized the first letter of every city
...
**Answer** It made every spelling of a city the same spelling (didnt group them together so they still had seprate counts), capitalized the first letter of every city and made the all CAPS cities lowercase
