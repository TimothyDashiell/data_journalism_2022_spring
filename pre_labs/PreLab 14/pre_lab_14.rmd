...
**Answer** A list of COVID related tweets from senators.
...
**Answer** Gives us a word list with the words we chose in ""
...
**Answer** A list of every word in every tweet from "Covid_tweets"
...
**Answer** A graph that provides us with how many times each word in each tweet was tweeted 
...
**Answer** It is because now the list has more medical or COVID related words instead of words like "the"
...
**Answer** This gives us those COVID related words, seperated by 2020 tweets and 2021 tweets
...
**Task** Run the following code and describe the results.
**Answer** A dataframe with some top word phrases from the tweets
...
**Task** Run the following code and describe the results.
**Answer** Another set of COVID related words
...
**Task** Run the following code and describe the results.
**Answer** Democrats and Republicans are both tweeting about COVID, just different acpects of COVID
...
**Task** Run the following code and describe the results.
**Answer** Repbulicans mention "Joe Biden" a lot (most likely while criticizing) while Democrats mention "Relief Grants"
...
**Answer** Trump is listed under "positive" which I tought was a mistake since his image wasn't the most positive at this point with people.
