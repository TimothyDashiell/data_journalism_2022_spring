...
**Answer** Error: Can't join on `x$zip` x `y$zip` because of incompatible types. This means that we tried to join two seprate types of data.
...
**Answer** Number- 419,68 Average Amount- 555,46.84 Median Amount-19,949
...
**Answer** Number- 112,056 Average- 89,194.67 Median- 20,833
...
**Answer** RURAL- Number (145) Average (44,815.22) Median (19,064.57)
           Urban- Number (41,823) Average (55,584.05) Median (19,950)
...
**Answer** RUAL: Number (18,083) Average (74,463.32) Median (20,833)
           URBAN: Number (93,973) Average (92,029.39) Median (20,833)
```{r}
