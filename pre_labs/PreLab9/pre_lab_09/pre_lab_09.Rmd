...
**Answer** Gave us the county name and total loans in a table format.
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** The data was made into a bar graph.
...
**Answer** The data was sorted in order from least to greatest.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The gray background was removed.
...
**Answer** The background was turned blue.
```{r}
maryland_ppp_top_counties %>%
ggplot() +
geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The Axis had new lables and a title was added.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** A table was created showing the date approved and the total number of loans.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** A (very confusing) line chart based on the data from that table.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** More dates were added on the bottom axis to break the data.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The dates were rotated so they wouldnt overlapp and could be easily read.
```{r}
ppp_maryland_loans_by_date %>%
  ggplot() + 
  geom_line(aes(x=date_approved, y=total_loans)) + 
