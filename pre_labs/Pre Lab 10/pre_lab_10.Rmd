...
**Answer** https://datawrapper.dwcdn.net/UHrmZ/1/
...
**Answer**  The code gives us the total PPP loans by the county that the recipient is based.
...
**Answer** The code filtered out the county numbers with less than six total loans, all of those counties were non Maryland counties
...
**Answer** There is a new column that combines the state_code and county_code to form the fips_code.
...
**Answer**Our fips dataframe now has our county ppp loans total from the other dataframe.
...
**Answer** Only showed me the state of Maryland because that's where all of our data is located.
...
**Answer** Now when you hover the cursor over a county, you see the county name, not the fips code.
...
**Answer** https://datawrapper.dwcdn.net/wLva0/2/
