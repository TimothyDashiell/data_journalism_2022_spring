...
**Answer** A large dataframe tracking vaccinations per county, per day, and other variables as well. 


```{r}
county_vaccinations_by_date <- read_csv("https://raw.githubusercontent.com/state-of-maryland/VaccineCSVs/master/MD_COVID19_TotalVaccinationsCountyFirstandSecondSingleDose.csv") %>%  clean_names()
...
**Answer** An NA row with 284 entries.
...
**Answer** Rows of entries from a county described as "NA".
...
**Answer** This data shows the dates of total full-vaccinations and where the county ranked on that day, compared to the other counties.
...
**Answer** A peak in May/April 2021 that decreasesuntil December 2021, then rises again.
...
**Answer** A gradual increase with a big jump around 01-2022.
...
**Task** Run the following code and describe what the resulting chart shows
**Answer** The jump in COVID-19 cases around 01-2022 is much less drastic.
...
**Answer** Number of COVID cases on 04-18-2022 in Maryland by county.
