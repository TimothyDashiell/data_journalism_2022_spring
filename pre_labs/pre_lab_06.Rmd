...
```{r}
lender_types <- read_csv("tabula-PPP_Report_Public_210531-508 (1).csv")
View(lender_types)
```
...
```{r}
lender_types <- read_csv("tabula-PPP_Report_Public_210531-508 (1).csv", skip=1, col_names=c("type", "count", "approved", "net_dollars"))
