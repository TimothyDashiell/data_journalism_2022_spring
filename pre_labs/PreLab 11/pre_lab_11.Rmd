...
**Answer** Different file types and sizes
...
**Answer** Hospital Address, Open or closed, contact info (telephone) and a geometry coloumn
...
**Answer** Showed only the hospitals in Maryland
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** GENERAL ACUTE CARE, PSYCHIATRIC, MILITARY,CHRONIC DISEASE, LONG TERM CARE	REHABILITATION and SPECIAL
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Now we only have one type of hospital data, for General acute care
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A scatter plot that ended up looking like the state shape 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The new library was loaded
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Data on all the counties in Maryland
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A map of the state of Maryland with counties
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The plot points were now added to the state outline
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Multicolored dots with a key to show how many beds are in each hospital
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** List of Maryland General Acute Care Hospitals
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A table of Total beds broken down by county
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Data frame with MD counties and population estimates.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Similar data frame, but with geometry data added in
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A data frame with county name and total beds.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A .shp file with population estimates and county geometry.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Similar data frame, but with total beds added.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Similar file, but without NAs.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Data frame with calculations of total beds and beds per 100,000 residents.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A  map of Maryland that displays counties in terms of the number of hospital beds available per 100,000 residents. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The beds per 100k variable is now displayed in color blocks insted of being blended.
...
**Answer**Baltimore City and Allegany County have the highest share of hospital beds per 100,000 residents.
