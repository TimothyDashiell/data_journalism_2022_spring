...
**Answer** A table with two digit nasics codes and what they represent 
...
**Answer** The source code that makes up the webpage
...
**Answer** Two lines of code, on for the header and one for the body of the page
...
**Answer** A list of 2 lines of code 
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** The diffrent elements that make up the header and the table
...
**Answer**6 different tables below
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** A list of 6, describing 6 different "tibble" values
...
**Answer** 6 different tables, some matching certian codes to descriptions, some matching characters to descriptions
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** A table showing the sector and the description they match
...
**Answer** Only the table we selected is shown now
...
**Answer** The table that was pur final resault from the last chapter of the sector and the description 
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** A bunch of different workforce statistics 
...
**Task** Run the following code to read in the html. Briefly describe the output that appears below the codeblock.
**Answer** 2 lines of code for the header and the body
...
**Answer** List of two with code for the header, body and footer
...
**Answer** A clean table with the number of employees
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** Workforce statistics for Mining, Quarrying, and Oil and Gas Extractio
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** Workforce Statistics for Construction 
...
**Answer** A list of all the sectors
```{r}
...
**Answer** A list of sectors was saved under "Values"
```{r}
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer** No error, the list is back
```{r}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer** Error, sector name not found
```{r, error=TRUE}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Answer** TA table of the sector and the industry the sector reprsents 
...
**Answer** The table with the employment number
...
**Task** Run the following code to load table from last chapter. Briefly describe the output that appears below the codeblock.
**Answer** The table with the cides and descriptions 
```{r}
# Define url of page we want to scrape
...
**Answer** The URL for each industry
...
**Answer** The url for each industry plus the sector path id
...
**Answer** A new table with the code filtered 
...
**Answer** Each sector has its own table with it's own url and id
...
**Answer** A data series table was formed with data filed in some spots
...
**Answer** each table now has employment numbers filled in
...
**Answer** tables were created with missing data filled in 
...
**Task** Run the following for loop to clean up tables. Briefly describe the output that appears below the codeblock.
**Answer** The data was cleaned and now each description has a clear number
...
**Answer** A singular table with all the dtata from the indivudual tables combined 
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** Mining, Quarrying, and Oil and Gas Extraction workforce statistics 
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** Workforce Statistics for the Agriculture sector
...
**Answer** The table with the number of employees, however the Agriculture, Forestry, Fishing and Hunting	was removed
